...
<template>
  <div class="auth-container h-screen flex align-middle">
    <div class="w-1/4 m-auto border-2 h-fit bg-gray-200 p-8">
      <!-- 
        if the response of the submit request reached the front end display 
       -->
      ...
      <div v-else>
        ...
        >
          ...
          <button class="block w-1/2 bg-slate-300 rounded mx-auto p-1" type="submit">
            register
          </button>
